...
extern int nondet_int(void);  //nondet input for CBMC
...
int SendSrbSynchronous(int Extension , int Srb , int Buffer , int BufferLength ) 
{ int ioStatus__Status = nondet_int() ;
  int ioctl ;
  int event = nondet_int() ;
  int irp ;
  int status = nondet_int() ;
  int __cil_tmp10 ;
  int __cil_tmp11 ;
  int __cil_tmp12 ;
  int __cil_tmp13 ;
...
int CdAudioStartDevice(int DeviceObject , int Irp ) 
{ int deviceExtension__Active = nondet_int() ;
  int deviceExtension = nondet_int() ;
  int status ;
  int srb = nondet_int() ;
  int srb__Cdb = nondet_int() ;
  int cdb ;
  int inquiryDataPtr ;
  int attempt ;
  int tmp ;
  int deviceParameterHandle = nondet_int() ;
  int keyValue ;
  {
  {
...
{ int Irp__Tail__Overlay__CurrentStackLocation = nondet_int() ;
  ...
  int irpSp__Parameters__UsageNotification__Type = nondet_int() ;
  int deviceExtension__PagingPathCountEvent = nondet_int() ;
  int irpSp__Parameters__UsageNotification__InPath = nondet_int() ;
  int deviceExtension__PagingPathCount = nondet_int() ;
...
{ int Irp__CurrentLocation = nondet_int() ;
  int Irp__Tail__Overlay__CurrentStackLocation = nondet_int() ;
  int deviceExtension__TargetDeviceObject = nondet_int() ;
  int tmp ;
...
int CdAudioIsPlayActive(int DeviceObject ) 
{ int deviceExtension__PlayActive = nondet_int() ;
  int ioStatus__Status = nondet_int() ;
  int currentBuffer__Header__AudioStatus = nondet_int() ;
  int irp_CdAudioIsPlayActive = nondet_int() ;
  int event = nondet_int() ;
  int status = nondet_int() ;
  int currentBuffer = nondet_int() ;
  int returnValue ;
  long __cil_tmp10 ;
  int __cil_tmp11 ;
...
{ int Irp__Tail__Overlay__CurrentStackLocation = nondet_int() ;
  ...
  int srb__Cdb = nondet_int() ;
  int currentIrpStack__Parameters__DeviceIoControl__IoControlCode = nondet_int() ;
  int Irp__IoStatus__Information ;
  int currentIrpStack__Parameters__DeviceIoControl__OutputBufferLength = nondet_int() ;
  int currentIrpStack__Parameters__DeviceIoControl__InputBufferLength = nondet_int() ;
  int srb__CdbLength ;
  int cdb__CDB10__OperationCode ;
  int srb__TimeOutValue ;
  int sizeof__READ_CAPACITY_DATA = nondet_int() ;
  int lastSession__LogicalBlockAddress = nondet_int() ;
  int cdaudioDataOut__FirstTrack = nondet_int() ;
  int cdaudioDataOut__LastTrack = nondet_int() ;
  int sizeof__CDROM_TOC = nondet_int() ;
  int sizeof__SUB_Q_CURRENT_POSITION = nondet_int() ;
  int userPtr__Format = nondet_int() ;
  int sizeof__CDROM_PLAY_AUDIO_MSF = nondet_int() ;
  int inputBuffer__StartingM = nondet_int() ;
  int inputBuffer__EndingM = nondet_int() ;
  int inputBuffer__StartingS = nondet_int() ;
  int inputBuffer__EndingS = nondet_int() ;
  int inputBuffer__StartingF = nondet_int() ;
  int inputBuffer__EndingF = nondet_int() ;
  int cdb__PLAY_AUDIO_MSF__OperationCode = nondet_int() ;
  int sizeof__CDROM_SEEK_AUDIO_MSF = nondet_int() ;
  int currentIrpStack ;
  int deviceExtension ;
  int cdaudioDataOut ;
  int srb = nondet_int() ;
  int lastSession = nondet_int() ;
  int cdb ;
  int status ;
  int i = nondet_int() ;
  int bytesTransfered = nondet_int() ;
  int Toc = nondet_int() ;
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
...
{ int currentIrpStack__Parameters__DeviceIoControl__IoControlCode = nondet_int() ;
  ...
  int sizeof__CDROM_PLAY_AUDIO_MSF = nondet_int() ;
  int sizeof__CDROM_SEEK_AUDIO_MSF = nondet_int() ;
  int deviceExtension__Paused = nondet_int() ;
  int deviceExtension__PlayActive ;
  int sizeof__SUB_Q_CHANNEL_DATA = nondet_int() ;
  int sizeof__SUB_Q_CURRENT_POSITION = nondet_int() ;
  int deviceExtension = nondet_int() ;
  int srb = nondet_int() ;
  int status ;
...
int HPCdrCompletion(int DeviceObject , int Irp , int Context ) 
{ int Irp__PendingReturned = nondet_int() ;
  int Irp__AssociatedIrp__SystemBuffer = nondet_int() ;
...
{ int pirp__IoStatus__Status ;
  ...
  int status = nondet_int() ;
  int irp = nondet_int() ;
  int we_should_unload = nondet_int() ;
