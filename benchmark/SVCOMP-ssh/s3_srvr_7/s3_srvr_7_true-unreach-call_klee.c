...
{ int s__info_callback = nondet_int() ;
  ...
  int s__shutdown ;
  int s__cert = nondet_int() ;
  int s__options = nondet_int() ;
  int s__verify_mode = nondet_int() ;
  int s__session__peer = nondet_int() ;
  int s__cert__pkeys__AT0__privatekey = nondet_int() ;
  int s__ctx__info_callback = nondet_int() ;
  int s__ctx__stats__sess_accept_renegotiate = nondet_int() ;
  int s__ctx__stats__sess_accept = nondet_int() ;
  int s__ctx__stats__sess_accept_good = nondet_int() ;
  ...
  int s__s3__tmp__new_cipher__algo_strength = nondet_int() ;
  ...
  int tmp___7 ;
  long tmp___8 = nondet_long() ;
  int tmp___9 = nondet_int() ;
  int tmp___10 = nondet_int() ;
  int blastFlag ;
  int __cil_tmp55 ;
