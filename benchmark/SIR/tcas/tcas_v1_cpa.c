...
void testme(){
	...
	CAUT_INPUT(Cur_Vertical_Sep);
	CAUT_INPUT(High_Confidence);
	CAUT_INPUT(Two_of_Three_Reports_Valid);
	CAUT_INPUT(Own_Tracked_Alt);
	CAUT_INPUT(Own_Tracked_Alt_Rate);
	CAUT_INPUT(Other_Tracked_Alt);
	CAUT_INPUT(Alt_Layer_Value);
	CAUT_INPUT(Up_Separation);
	CAUT_INPUT(Down_Separation);
	CAUT_INPUT(Other_RAC);
	CAUT_INPUT(Other_Capability);
	CAUT_INPUT(Climb_Inhibit);
	
	alt_sep_test();
}
*/

//This testme is dedicated for CPAchecker
void testme(){

    initialize();
	Cur_Vertical_Sep = __VERIFIER_nondet_int();
	High_Confidence = __VERIFIER_nondet_int();
	Two_of_Three_Reports_Valid = __VERIFIER_nondet_int();
	Own_Tracked_Alt = __VERIFIER_nondet_int();
	Own_Tracked_Alt_Rate = __VERIFIER_nondet_int();
	Other_Tracked_Alt = __VERIFIER_nondet_int();
	Alt_Layer_Value = __VERIFIER_nondet_int();
	Up_Separation = __VERIFIER_nondet_int();
	Down_Separation = __VERIFIER_nondet_int();
	Other_RAC = __VERIFIER_nondet_int();
	Other_Capability = __VERIFIER_nondet_int();
	Climb_Inhibit = __VERIFIER_nondet_int();
