...
int DiskPerfRemoveDevice(int DeviceObject , int Irp ) 
{ int DeviceObject__DeviceExtension = nondet_int() ;
  int deviceExtension__WmilibContext = nondet_int() ;
  int Irp__IoStatus__Status ;
  int status ;
  int deviceExtension ;
  int wmilibContext ;
...
int DiskPerfIoCompletion(int DeviceObject , int Irp , int Context ) 
{ int irpStack__MajorFunction = nondet_int() ;
  int partitionCounters__BytesRead__QuadPart = nondet_int() ;
  int Irp__IoStatus__Information = nondet_int() ;
  int partitionCounters__ReadCount = nondet_int() ;
  int partitionCounters__ReadTime__QuadPart = nondet_int() ;
  int difference__QuadPart = nondet_int() ;
  int partitionCounters__BytesWritten__QuadPart = nondet_int() ;
  int partitionCounters__WriteCount = nondet_int() ;
  int partitionCounters__WriteTime__QuadPart = nondet_int() ;
  int Irp__Flags = nondet_int() ;
  int partitionCounters__SplitCount = nondet_int() ;
  int Irp__PendingReturned = nondet_int() ;
  int Irp__Tail__Overlay__CurrentStackLocation__Control ;
  int partitionCounters = nondet_int() ;
  int queueLen = nondet_int() ;
...
{ int Irp__CurrentLocation = nondet_int() ;
  ...
  int sizeof__DISK_PERFORMANCE = nondet_int() ;
  int Irp__IoStatus__Information ;
  int deviceExtension__DiskCounters = nondet_int() ;
  int Irp__AssociatedIrp__SystemBuffer = nondet_int() ;
  int deviceExtension__Processors = nondet_int() ;
  int totalCounters__QueueDepth ;
  int deviceExtension__QueueDepth = nondet_int() ;
  int Irp__IoStatus__Status ;
  int deviceExtension ;
  int currentIrpStack ;
  int status ;
...
{ int DeviceObject__DeviceExtension = nondet_int() ;
  int deviceExtension__TargetDeviceObject = nondet_int() ;
  int sizeof__number = nondet_int() ;
  int ioStatus__Status = nondet_int() ;
  int sizeof__VOLUME_NUMBER = nondet_int() ;
  int volumeNumber__VolumeManagerName__0 = nondet_int() ;
  int status ;
  ...
  int output__NameLength = nondet_int() ;
  int outputSize ;
  int output = nondet_int() ;
  int volumeNumber = nondet_int() ;
  int __cil_tmp20 ;
  int __cil_tmp21 ;
  int __cil_tmp22 ;
  long __cil_tmp23 ;
