...
{ int devExt ;
  ...
  int irpStack__MinorFunction = nondet_int() ;
  int devExt__TopOfStack = nondet_int() ;
  int devExt__Started ;
  int devExt__Removed ;
...
{ int irpStack__MajorFunction = nondet_int() ;
  int devExt__UpperConnectData__ClassService = nondet_int() ;
  int Irp__IoStatus__Status ;
  int status ;
  int tmp ;
...
{ int Irp__Tail__Overlay__CurrentStackLocation = nondet_int() ;
  int Irp__CurrentLocation = nondet_int() ;
  int DeviceObject__DeviceExtension__TopOfStack = nondet_int() ;
  int irpStack ;
  int tmp ;
...
{ int irpStack__MinorFunction = nondet_int() ;
  ...
  int powerState__DeviceState = nondet_int() ;
  int Irp__CurrentLocation = nondet_int() ;
  int Irp__Tail__Overlay__CurrentStackLocation = nondet_int() ;
  int devExt__TopOfStack = nondet_int() ;
  int powerType = nondet_int() ;
  int tmp ;
...
int KbFilter_InternIoCtl(int DeviceObject , int Irp ) 
{ int Irp__IoStatus__Information ;
  int irpStack__Parameters__DeviceIoControl__IoControlCode = nondet_int() ;
  int devExt__UpperConnectData__ClassService = nondet_int() ;
  int irpStack__Parameters__DeviceIoControl__InputBufferLength = nondet_int() ;
  int sizeof__CONNECT_DATA = nondet_int() ;
  int irpStack__Parameters__DeviceIoControl__Type3InputBuffer = nondet_int() ;
  int sizeof__INTERNAL_I8042_HOOK_KEYBOARD = nondet_int() ;
  int hookKeyboard__InitializationRoutine = nondet_int() ;
  int hookKeyboard__IsrRoutine = nondet_int() ;
  int Irp__IoStatus__Status ;
  int hookKeyboard ;
  int connectData ;
  int status ;
  ...
  int __cil_tmp18 ;
  int __cil_tmp19 ;
  int __cil_tmp20 = nondet_int() ;
  int __cil_tmp21 ;
  int __cil_tmp22 ;
  int __cil_tmp23 ;
  int __cil_tmp24 = nondet_int() ;
  int __cil_tmp25 ;
  int __cil_tmp26 ;
  int __cil_tmp27 ;
  int __cil_tmp28 = nondet_int() ;
  int __cil_tmp29 = nondet_int() ;
  int __cil_tmp30 ;
  int __cil_tmp31 ;
  int __cil_tmp32 = nondet_int() ;
  int __cil_tmp33 ;
  int __cil_tmp34 ;
  int __cil_tmp35 = nondet_int() ;
  int __cil_tmp36 ;
  int __cil_tmp37 ;
  int __cil_tmp38 = nondet_int() ;
  int __cil_tmp39 ;
  int __cil_tmp40 ;
