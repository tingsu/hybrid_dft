...
int FlQueueIrpToThread(int Irp , int DisketteExtension ) 
{ int status ;
  int threadHandle = nondet_int() ;
  int DisketteExtension__PoweringDown = nondet_int() ;
  int DisketteExtension__ThreadReferenceCount = nondet_int() ;
  int DisketteExtension__FloppyThread = nondet_int() ;
  int Irp__IoStatus__Status ;
  int Irp__IoStatus__Information ;
  int Irp__Tail__Overlay__CurrentStackLocation__Control ;
  int ObjAttributes = nondet_int() ;
  int __cil_tmp12 ;
  int __cil_tmp13 ;
...
int FloppyPnp(int DeviceObject , int Irp ) 
{ int DeviceObject__DeviceExtension = nondet_int() ;
  int Irp__Tail__Overlay__CurrentStackLocation = nondet_int() ;
  int Irp__IoStatus__Information ;
  int Irp__IoStatus__Status ;
  int Irp__CurrentLocation = nondet_int() ;
  int disketteExtension__IsRemoved = nondet_int() ;
  int disketteExtension__IsStarted = nondet_int() ;
  int disketteExtension__TargetObject = nondet_int() ;
  int disketteExtension__HoldNewRequests ;
  int disketteExtension__FloppyThread = nondet_int() ;
  int disketteExtension__InterfaceString__Buffer = nondet_int() ;
  int disketteExtension__InterfaceString = nondet_int() ;
  int disketteExtension__ArcName__Length = nondet_int() ;
  int disketteExtension__ArcName = nondet_int() ;
  int irpSp__MinorFunction = nondet_int() ;
  int IoGetConfigurationInformation__FloppyCount = nondet_int() ;
  int irpSp ;
  int disketteExtension ;
  int ntStatus ;
  int doneEvent = nondet_int() ;
  int irpSp___0 ;
  int nextIrpSp ;
...
{ int DeviceObject__DeviceExtension = nondet_int() ;
  ...
  int pnpStatus ;
  int doneEvent = nondet_int() ;
  int fdcInfo = nondet_int() ;
  int fdcInfo__BufferCount ;
  int fdcInfo__BufferSize ;
  int fdcInfo__MaxTransferSize = nondet_int() ;
  int fdcInfo__AcpiBios = nondet_int() ;
  int fdcInfo__AcpiFdiSupported = nondet_int() ;
  int fdcInfo__PeripheralNumber = nondet_int() ;
  int fdcInfo__BusType ;
  int fdcInfo__ControllerNumber = nondet_int() ;
  int fdcInfo__UnitNumber = nondet_int() ;
  int fdcInfo__BusNumber = nondet_int() ;
  int Dc ;
  int Fp ;
  int disketteExtension ;
  int irpSp ;
  ...
  int irpSp__Context ;
  int InterfaceType ;
  int KUSER_SHARED_DATA__AlternativeArchitecture_NEC98x86 = nondet_int() ;
  long __cil_tmp42 ;
  int __cil_tmp43 ;
  int __cil_tmp44 ;
  int __cil_tmp45 ;
  int __cil_tmp46 = nondet_int() ;
  int __cil_tmp47 ;
  int __cil_tmp48 ;
  int __cil_tmp49 ;
...
{ int status ;
  ...
  int irp_choice = nondet_int() ;
  int devobj = nondet_int() ;
  int __cil_tmp8 ;
...
int FloppyQueueRequest(int DisketteExtension , int Irp ) ;
int FloppyDeviceControl(int DeviceObject , int Irp ) 
{ int disketteExtension__HoldNewRequests = nondet_int() ;
  int disketteExtension__IsRemoved = nondet_int() ;
  int Irp__IoStatus__Information ;
  int disketteExtension__IsStarted = nondet_int() ;
  int Irp__CurrentLocation = nondet_int() ;
  int Irp__Tail__Overlay__CurrentStackLocation = nondet_int() ;
  int disketteExtension__TargetObject = nondet_int() ;
  int irpSp__Parameters__DeviceIoControl__OutputBufferLength = nondet_int() ;
  int sizeof__MOUNTDEV_NAME = nondet_int() ;
  int Irp__AssociatedIrp__SystemBuffer = nondet_int() ;
  int mountName__NameLength ;
  int disketteExtension__DeviceName__Length = nondet_int() ;
  int sizeof__USHORT = nondet_int() ;
  int disketteExtension__InterfaceString__Buffer = nondet_int() ;
  int uniqueId__UniqueIdLength ;
  int disketteExtension__InterfaceString__Length = nondet_int() ;
  int sizeof__MOUNTDEV_UNIQUE_ID = nondet_int() ;
  int irpSp__Parameters__DeviceIoControl__InputBufferLength = nondet_int() ;
  int sizeof__FORMAT_PARAMETERS = nondet_int() ;
  int irpSp__Parameters__DeviceIoControl__IoControlCode___1 = nondet_int() ;
  int sizeof__FORMAT_EX_PARAMETERS = nondet_int() ;
  int formatExParameters__FormatGapLength = nondet_int() ;
  int formatExParameters__SectorsPerTrack = nondet_int() ;
  int sizeof__DISK_GEOMETRY = nondet_int() ;
  int Irp__IoStatus__Status___0 ;
  int disketteExtension = nondet_int() ;
  int ntStatus ;
  int outputBufferLength ;
  int lowestDriveMediaType = nondet_int() ;
  int highestDriveMediaType = nondet_int() ;
  int formatExParametersSize = nondet_int() ;
  ...
  int __cil_tmp39 ;
  int __cil_tmp40 ;
  int __cil_tmp41 = nondet_int() ;
  int __cil_tmp42 ;
  int __cil_tmp43 ;
  int __cil_tmp44 = nondet_int() ;
  int __cil_tmp45 = nondet_int() ;
  int __cil_tmp46 ;
  int __cil_tmp47 ;
  int __cil_tmp48 ;
  int __cil_tmp49 ;
  int __cil_tmp50 = nondet_int() ;
  int __cil_tmp51 ;
  int __cil_tmp52 ;
  int __cil_tmp53 ;
  int __cil_tmp54 ;
  int __cil_tmp55 = nondet_int() ;
  int __cil_tmp56 ;
  int __cil_tmp57 ;
  int __cil_tmp58 ;
  int __cil_tmp59 ;
  int __cil_tmp60 = nondet_int() ;
  int __cil_tmp61 ;
  int __cil_tmp62 ;
  int __cil_tmp63 ;
  int __cil_tmp64 ;
  int __cil_tmp65 = nondet_int() ;
  int __cil_tmp66 = nondet_int() ;
  int __cil_tmp67 ;
  int __cil_tmp68 ;
  int __cil_tmp69 = nondet_int() ;
  int __cil_tmp70 ;
  int __cil_tmp71 ;
  int __cil_tmp72 = nondet_int() ;
  int __cil_tmp73 ;
  int __cil_tmp74 ;
  int __cil_tmp75 = nondet_int() ;
  int __cil_tmp76 ;
  int __cil_tmp77 ;
  int __cil_tmp78 = nondet_int() ;
  int __cil_tmp79 ;
  int __cil_tmp80 ;
  int __cil_tmp81 = nondet_int() ;
  int __cil_tmp82 ;
  int __cil_tmp83 ;
  int __cil_tmp84 ;
  int __cil_tmp85 ;
...
int FlCheckFormatParameters(int DisketteExtension , int FormatParameters ) 
{ int DriveMediaConstants__driveMediaType__MediaType = nondet_int() ;
  int FormatParameters__MediaType = nondet_int() ;
  int FAKE_CONDITION = nondet_int() ;
