...
char* my_fgets(char* s, int maxsize){
	...
	int i;
	for(i=0; i<maxsize; i++)
	   s[i] = __VERIFIER_nondet_char(); //__VERIFIER_nondet_char() gives input string for replacement
	if(s[0] == '\0')
	   return REPLACE_NULL;
        else
	   return s;
...
test_main(void) // "main" -> "test_main"
{
   ...
   argc = __VERIFIER_nondet_int();
   for(i=0;i<MAXSTR; i++){
	argv_1[i] = __VERIFIER_nondet_char();
	argv_2[i] = __VERIFIER_nondet_char();
   }
