...
{ int s__info_callback = nondet_int() ;
  int s__in_handshake = nondet_int() ;
  int s__state ;
  int s__new_session ;
  int s__server ;
  int s__version = nondet_int() ;
  int s__type ;
  int s__init_num ;
  int s__bbio = nondet_int() ;
  int s__wbio = nondet_int() ;
  int s__hit = nondet_int() ;
  int s__rwstate ;
  int s__init_buf___0 ;
  int s__debug = nondet_int() ;
  int s__shutdown ;
  int s__ctx__info_callback = nondet_int() ;
  int s__ctx__stats__sess_connect_renegotiate = nondet_int() ;
  int s__ctx__stats__sess_connect = nondet_int() ;
  int s__ctx__stats__sess_hit = nondet_int() ;
  int s__ctx__stats__sess_connect_good = nondet_int() ;
  int s__s3__change_cipher_spec ;
  int s__s3__flags ;
  int s__s3__delay_buf_pop_ret ;
  int s__s3__tmp__cert_req = nondet_int() ;
  int s__s3__tmp__new_compression = nondet_int() ;
  int s__s3__tmp__reuse_message = nondet_int() ;
  int s__s3__tmp__new_cipher = nondet_int() ;
  int s__s3__tmp__new_cipher__algorithms = nondet_int() ;
  int s__s3__tmp__next_state___0 ;
  int s__s3__tmp__new_compression__id = nondet_int() ;
  ...
  int tmp___2 = nondet_int() ;
  int tmp___3 = nondet_int() ;
  int tmp___4 = nondet_int() ;
  int tmp___5 = nondet_int() ;
  int tmp___6 = nondet_int() ;
  int tmp___7 = nondet_int() ;
  int tmp___8 = nondet_int() ;
  int tmp___9 = nondet_int() ;
  int blastFlag ;
  int __cil_tmp55 ;
  long __cil_tmp56 ;
  long __cil_tmp57 ;
                                                                  ...
                                                                  if (s__state == 4352) {
                                                                    ...
                                                                    if (s__state == 3) {
                                                                      ...
                                                                      if (0) {
                                                                        ...
                                                                        if (blastFlag == 5) {
									  //goto ERROR;
                                                                          goto end2; //substitute the ERROR flag by Ting Su
                                                                        }
                                                                        if (ret <= 0) {
                                                                          goto end;
                                                                        }
